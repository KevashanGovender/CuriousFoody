 ...
 */
public class RandomRecipeWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.last_favorited_recipe_widget);
